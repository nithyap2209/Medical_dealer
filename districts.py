"""
Comprehensive mapping of all Indian States and Union Territories to their districts.
Based on district data as of 2024. Includes all 28 states and 8 union territories.
"""
...
STATES_DISTRICTS = {
    ...
    "Karnataka": [
        ...
        "Raichur", "Ramanagara", "Shimoga", "Tumakuru", "Udupi",
    ...
    "Madhya Pradesh": [
        ...
        "Morena", "Mauganj", "Narsinghpur", "Neemuch", "Niwari",
    ...
    "Maharashtra": [
        ...
        "Nagpur", "Nanded", "Nandurbar", "Nashik", "Palghar",
    ...
    "Punjab": [
        ...
        "Mohali (S.A.S. Nagar)", "Muktsar", "Pathankot", "Patiala",
    ...
    "Sikkim": [
        "Gangtok", "Gyalshing", "Mangan", "Namchi", "Pakyong",
        "Soreng",
    ],
    "Tamil Nadu": [
        ...
        "Tirupattur", "Tiruvallur", "Tiruvannamalai",
